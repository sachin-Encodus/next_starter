...
export default function Home() {
  return (
    <Layout>
      ...
      <div style={{zIndex:9}} className="my-10 grid w-full max-w-screen-xl animate-[slide-down-fade_0.5s_ease-in-out] grid-cols-1 gap-5 px-5  xl:px-0">
